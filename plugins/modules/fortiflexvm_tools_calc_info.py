...
DOCUMENTATION = '''
---
module: fortiflexvm_tools_calc_info
short_description: Estimate points that will be consumed for configuration with certain parameters.
description:
    ...
    for product_name in products:
        if ignore_validation:
            ...
            for param in products[product_name]["parameters"]:
                ...
                if param["id"] == 47:  # fortiEDR -> endpoints
...
def main():
    ...
    response = connection.send_request("fortiflex/v2/tools/calc", data, method="POST")
